...
"}"));
        ...
        BackCarLb = new QLabel(Appwidget);
        BackCarLb->setObjectName("BackCarLb");
        BackCarLb->setGeometry(QRect(530, 230, 81, 21));
...
"}"));
        ...
        PaidButton->setGeometry(QRect(300, 130, 100, 100));
...
"    padding: 5px;\n"
"}"));
        BackCarButton = new BackCarBt(Appwidget);
        BackCarButton->setObjectName("BackCarButton");
        BackCarButton->setGeometry(QRect(520, 130, 100, 100));
...
"}"));
        ...
        MusicLb->setGeometry(QRect(300, 110, 111, 21));
        ...
        SeatButton->setGeometry(QRect(75, 130, 100, 100));
